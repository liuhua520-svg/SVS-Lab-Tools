...
本项目的软件部分，包括源代码及其他属于软件组成部分的文件，采用 **MIT License**。

除另有说明外，本项目中由作者原创的非软件内容，例如原创文档、原创示例、说明文字及其他非软件作品，采用 **CC0 1.0 Universal**。

第三方模型、字典、声库、数据集、第三方软件及其衍生文件仍遵循各自的许可证或授权条款；本项目采用的 MIT License 和 CC0 1.0 Universal 不改变这些第三方内容原有的授权方式。

**许可证适用范围说明：**

* 软件及源代码：MIT License
* 作者原创的非软件内容：CC0 1.0 Universal
* 第三方内容：遵循其各自的许可证或授权条款
